...
new TypeIt("#teks1", {
  strings: ["Yuna, Aku minta maaf karena dulu tiba tiba menghilang tanpa kabar.","Sekarang aku sadar kalau itu pasti bikin kamu kecewa dan bingung.","Aku tidak punya alasan yang bisa membenarkan semuanya, aku memang salah waktu itu.", "Aku sadar itu bukan hal yang baik untuk dilakukan ke seseorang, apalagi ke orang yang pernah dekat dan peduli."],
  startDelay: 4000,
  speed: 75,
...
new TypeIt("#teks2", {
  strings: ["Aku juga minta maaf karena datang lagi setelah sekian lama.", "Aku cuma tidak ingin terus menyimpan penyesalan tanpa pernah mencoba memperbaikinya." , "Aku cuma tidak ingin terus menyimpan penyesalan tanpa pernah mencoba memperbaikinya.", " ", "- Thank you for being part of my life. I'm sorry."],
  startDelay: 2000,
  speed: 75,
  waitUntilVisible: true
}).go();
